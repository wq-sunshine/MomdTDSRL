...
from Modules.build_encoding import read_decodings, decode
from Modules.rewards0 import evaluate_chem_mol
...
def main(epoch, savefile=None, imagefile=None):
    ...
    plot = Draw.MolsToGridImage(plot_mols[:50], molsPerRow=2)#最后生成50个分子
